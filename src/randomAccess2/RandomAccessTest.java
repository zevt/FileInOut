...
public class RandomAccessTest {
	private static String FILENAME = "src/randomAccess2/employee.dat";
	public static void main(String[] args) throws IOException {
		...
		try (FileChannel channel = FileChannel.open(path, StandardOpenOption.READ)) {
			...
			for (int i = n - 1; i >= 0; i--) {
				...
				channel.read(buffer);
				buffer.flip();
				newStaff[i] = readBlockData(buffer);
			}
	 ...
	 *            the employee
	 */
	public static void writeBlockData(ByteBuffer out, Employee e) throws IOException {
	 ...
	 * @return the employee
	 */
	public static Employee readBlockData(ByteBuffer in) throws IOException {
